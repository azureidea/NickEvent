 ...
 * @date 2018-3-28
 * @version 1.0
 * @description NickFlex.js主要解决移动端适配问题，解决REM单位下产生的问题以及REM单位在开发及维护中的不便。
 *  解决了REM单位下1像素边框的问题，解决了REM单位下字体可能异常变大的问题，解决了REM单位下所有图片或背影都需要设置尺寸的问题，
 *  解决了REM单位下处处需要进行计算的问题，解决了REM单位下图片放大失真需要2X 3X图的问题，解决了REM单位在PC下看下来特别大的问题。
 * @example 使用方法如下
